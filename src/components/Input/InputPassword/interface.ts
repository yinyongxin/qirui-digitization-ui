...
export interface InputPasswordBaseInterFace {
  /**
* √
* 	默认值
*/
...
export type InputPasswordPropsType = InputPasswordBaseInterFace & InputCurrencyType & Pick<JSX.IntrinsicElements['div'], 'style' | 'className'>